...
class_arrays = {
    ...
    'Social Post': ["content-wrapper", "org-logo","footer", "org-tagline", "org-address", "org-alternate-email", "org-phone", "fas", "fa-whatsapp", "org-phone1", "org-alternate-phone", "fas", "fa-phone", "org-fax", "fas", "fa-fax", "heading-first", "heading", "sub-heading", "description", "punchline-1", "punchline-2", "offerline-1", "offerline-2", "services-heading", "services", "service", "service-name", "service-image", "service-description", "contact-us", "contact", "Location", "Location-image", "Location-imagee", "features-heading", "feature-imagee", "features", "feature", "feature-name1", "feature-image1", "feature-description", "feature-name2", "feature-image2", "feature-name3", "feature-image3", "feature-name4", "feature-image4", "feature-name5", "feature-image5", "feature-name6", "feature-image6", "feature-name7", "feature-image7", "terms-heading", "term-image-MEMBERSHIP", "terms", "term", "term-name", "term-image1", "term-description", "term-image2", "term-name", "term-image3", "term-image-MEMBERSHIP1","org-website", "org-email",  "org-name", "term-description"],
    'Greeting Card': ["greeting-content","greeting-wrapper", "greeting-recipient-name", "greeting-heading", "greeting-sub-heading", "greeting-pre-message", "greeting-message", "greeting-closing-message", "greeting-sender-name", "greeting-personal-note", "greeting-date", "greeting-occasion", "greeting-image", "greeting-additional-image", "greeting-special-instructions"],
