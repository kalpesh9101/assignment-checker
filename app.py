...
class_arrays = {
    ...
    'Visiting': ["card-wrapper","content-wrapper","socialpost-wrapper", "socialpost-background",  "org-logo", "org-tagline", "org-address", "heading-first", "heading", "sub-heading", "description"],
